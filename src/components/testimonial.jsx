...
const testimonials = [
  ...
  },
  {
    ...
    illustration:
      "https://cdn.sanity.io/images/e5ozko3p/production/d24b40ef2d74054bb897a462ca49ff934527561a-295x300.svg?auto=format",
    companyLogo: "/log1.svg",
    quote:
      '"Paraform helped us scale our engineering team quickly and efficiently."',
    author: "Sarah Chen",
  ...
  },
  {
    ...
    companyLogo: "/terra.svg",
    quote:
      '"The efficiency gains have been remarkable. We\'ve streamlined our entire hiring process."',
        ...
        <div key={item.id} style={styles.accordionItem}>
          <AnimatePresence initial={false}>
            {openId !== item.id && (
              ...
              >
                <div
                  style={isMobile ? styles.headerLeftMobile : styles.headerLeft}
                >
                ...
                <p style={isMobile ? styles.summaryMobile : styles.summary}>
                  {item.summary}
                  <span
                    style={isMobile ? styles.highlightMobile : styles.highlight}
                  >
                    {item.highlight}
                  </span>
                </p>
              ...
              >
                <div style={isMobile ? styles.contentMobile : styles.content}>
                  <motion.div
                    ...
                    style={
                      isMobile
                        ? styles.illustrationWrapperMobile
                  ...
                  <div style={styles.textContent}>
                    ...
                    >
                      <div
                        style={
                          isMobile ? styles.authorInfoMobile : styles.authorInfo
                        }
                      >
